        ...
        >
          ...
          <Offcanvas.Body>
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#Veranstaltungen" onClick={()=> onPageChange('Veranstaltungen')}>Veranstaltungen</Nav.Link>
              <Nav.Link href="#Kontakt" onClick={() => onPageChange('Kontakt')}>Kontakt</Nav.Link>
            </Nav>
          </Offcanvas.Body>
        </Navbar.Offcanvas>
      </Container>
